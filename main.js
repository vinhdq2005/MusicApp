...
const rangeBar = document.querySelector(".range-music");
const rangeMusic = document.querySelector(".range-volume")
...
rangeMusic.addEventListener("change", changeVolume)
function changeVolume() {
  song.volume = (rangeMusic.value)/100
}
